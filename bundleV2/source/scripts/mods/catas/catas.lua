...
--Fix Chaos Troll
BreedActions.chaos_troll_chief.downed.downed_duration = { 120, 120, 90, 75, 75, 75, 75, 75 }
BuffTemplates.troll_chief_downed.buffs[1].time_between_heal = { 1,1,1,0.5,0.25, 0.25, 0.25, 0.25 }
...
local widget_settings = {
	--[[["diff_stagger_resist.chaos_bulwark"] = function()
		if mod:get("diff_stagger_resist.chaos_bulwark") then
			for i=1, difficulties do 
				local i = i + difficulty_start
